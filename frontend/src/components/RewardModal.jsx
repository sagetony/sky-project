...
const RewardModal = ({ onclose }) => {
  ...
  return (
    ...
    >
      <div className=' md:max-h-[620px]  [scrollbar-width:none] [--ms-overflow-style:none] [&::-webkit-scrollbar]:hidden max-h-[600px] overflow-auto text-white rounded-3xl  w-full md:w-2/4'>
        ...
        <div className='bg-white py-10 '>
          <div className=' relative'>
            ...
            <div className='bg-login mx-44 pb-10 shadow-card pt-14 rounded-[50px] relative'>
              <img
                src={banner_l}
                alt=''
                className='absolute -left-[90px] top-7'
              />
              <img
                src={banner_r}
                alt=''
                className='absolute -right-[90px] top-7'
              />
              <div
              ...
              <div className='py-10 md:px-20 px-10 text-[#F9F9F4]'>
            ...
            <div className='flex mx-44 gap-5 justify-between mt-10 items-center'>
              <BlueButton
                text={`Claim all`}
              ...
              />
              <button className='flex-1 border-[3px] py-2 hover:bg-[#184C7F] hover:text-white rounded-full text-xl font-semibold border-[#184C7F] text-[#184C7F]'>
                Learn more
              </button>
            </div>
          </div>
