    ...
    <div className="bg-content relative p-16 px-5 md:px-28 text-white">
      <div className="absolute inset-0 z-0">
        ...
        <img
          src={Cloud2}
          alt=""
          className="absolute md:top-[1000px] top-[2900px] left-0 w-64 animate-upAndDown"
        />
        <img
          src={Cloud3}
          alt=""
        ...
        <img
          src={Cloud3}
          alt=""
          className="absolute md:top-[1000px] top-[2000px] right-0 w-64 animate-upAndDown"
        />
      </div>{" "}
        ...
        <div className="flex md:flex-row flex-col-reverse justify-between gap-16">
          <div className="md:w-1/2">
            <div className="mb-20">
              ...
              <p>
                <Translations text="position_info2" />
              </p>
            </div>
          </div>
